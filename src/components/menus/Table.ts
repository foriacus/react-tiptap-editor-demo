  ...
  createMenuElement() {
    ...
    div.innerHTML = `
        <div style="margin: 5px">
            <div style="padding: 5px 0;font-size: 14px;display: flex"><span>${t(
              "insertTable"
            )}</span><span style="margin-left: auto" id="columnRows"></span></div>
    ...
    tableCells.addEventListener("mouseover", (e) => {
      ...
      if (target) {
        ...
        querySelector.textContent = `${targetI + 1} ${t("row")} x ${
          targetJ + 1
        } ${t("column")}`;
